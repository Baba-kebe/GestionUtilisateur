...
public class AddUserForm {
	...
	public boolean ajouter() {
		...
		this.user = new User(nom, prenom, login, datedenaissance, password);	 
		...
		if (this.erreurs.isEmpty()) {
			...
			if (this.status) {
				this.statusMessage = "Utilisateur ajouté avec succes";
			} else {
				this.statusMessage = "Echec de l'ajout d'utilisateur";
			}
		}	
